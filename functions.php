...
function pt_properties_archive_title( $orig ) {
    ...
    if ( defined( 'ICL_LANGUAGE_CODE' ) && ICL_LANGUAGE_CODE === 'fr' ) {
        return 'Maisons à vendre | l’Ouest-de-l’Île et Vaudreuil-Soulanges | Peter Thompson Immobilier';
    }
    return 'Homes for Sale | West Island & Vaudreuil-Soulanges | Peter Thompson Real Estate';
}
...
function pt_properties_archive_metadesc( $orig ) {
    ...
    if ( defined( 'ICL_LANGUAGE_CODE' ) && ICL_LANGUAGE_CODE === 'fr' ) {
        return 'Commencez votre parcours immobilier en explorant les maisons à vendre dans les régions de l’Ouest-de-l’Île et de Vaudreuil-Soulanges. Contactez-nous pour planifier une visite !';
    }
    return 'Start your real estate journey by exploring homes for sale across the West Island and Vaudreuil-Soulanges regions. Contact us to schedule your visit!';
}
// ────────────────────────────────────────────────────────────────────
